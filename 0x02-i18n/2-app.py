...
# Here you're importing the Flask class, the render_template function, and the request object from the flask module.
...
# This decorator registers a function to be used to select the locale for each request.
def get_locale():
    """doc doc doc"""
    # This is a docstring, it's used to describe what your function does.
    return request.accept_languages.best_match(app.config["LANGUAGES"])
    # This function returns the best language match from the accepted languages in the request.
